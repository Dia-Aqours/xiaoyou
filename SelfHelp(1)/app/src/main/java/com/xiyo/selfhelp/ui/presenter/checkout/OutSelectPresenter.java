...
public class OutSelectPresenter<V extends OutSelectMvpView> extends BasePresenter<V> implements OutSelectMvpPresenter<V> {
    ...
    @Inject
    public OutSelectPresenter(DataManager dataManager) {
