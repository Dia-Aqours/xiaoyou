package com.xiyo.selfhelp.ui.view.card;
...
public interface CardComparisonMvpView extends MvpView {
    ...
    void getAuthenticaTokenListSuccess(AuthenticaTokenModel authenticaTokenModel);
    void getAuthenticaTokenListFail(String error);
}
