...
import com.xiyo.selfhelp.ui.mvppresenter.stay.StaySelectMvpPresenter;
...
public class StaySelectPresenter<V extends StaySelectMvpView> extends BasePresenter<V> implements StaySelectMvpPresenter<V> {
    ...
    @Inject
    public StaySelectPresenter(DataManager dataManager) {
