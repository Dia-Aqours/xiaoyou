...
public class WeiPayPresenter<V extends WeiPayMvpView> extends BasePresenter<V> implements WeiPayMvpPresenter<V> {
    ...
    @Inject
    public WeiPayPresenter(DataManager dataManager) {
