...
import com.xiyo.selfhelp.widget.FloatingView;
    ...
    public void showFloatBall() {
        ...
        floatBall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EventBus.getDefault().post(FloatBallAccessibilityService.BACK);
            }
        });
        ...
        floatBall.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                EventBus.getDefault().post(FloatBallAccessibilityService.HOME);
                return false;
            }
        });
