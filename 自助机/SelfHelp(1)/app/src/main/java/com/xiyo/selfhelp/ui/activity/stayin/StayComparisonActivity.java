...
import com.xiyo.selfhelp.ui.presenter.stay.StayComparisonPresenter;
...
public class StayComparisonActivity extends BaseActivity implements StayComparisonMvpView {
    ...
    @Inject
    StayComparisonPresenter<StayComparisonMvpView> mStayComparisonPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStayComparisonPresenter.attachView(this);
        initData();
    }
    ...
    public void getCheckInOrderSuccess(List<CheckInOrder> checkInOrders) {
        if(checkInOrders != null){
            if(checkInOrders.size() > 0){
                Intent intent = new Intent(this, StaySelectActivity.class);
                ...
                Intent intent = new Intent(this, StayNoRoomActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
...
//                startTimer();
    ...
    private void login(){
        ...
        mStayComparisonPresenter.login(fields);
    }
    ...
    private void getCheckInOrder(Token token){
        ...
        if(card != null){
            ...
            if(!json.isEmpty()){
                ...
                mStayComparisonPresenter.getCheckInOrder(fields);
            }
        }
    }
