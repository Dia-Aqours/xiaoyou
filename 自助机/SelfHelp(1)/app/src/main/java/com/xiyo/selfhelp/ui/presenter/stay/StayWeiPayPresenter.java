...
public class StayWeiPayPresenter<V extends StayWeiPayMvpView> extends BasePresenter<V> implements StayWeiPayMvpPresenter<V> {
    ...
    @Inject
    public StayWeiPayPresenter(DataManager dataManager) {
