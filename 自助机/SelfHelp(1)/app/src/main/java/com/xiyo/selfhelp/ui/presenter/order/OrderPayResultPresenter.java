...
import com.xiyo.selfhelp.ui.mvppresenter.order.OrderPayResultMvpPresenter;
...
public class OrderPayResultPresenter<V extends OrderPayResultMvpView> extends BasePresenter<V> implements OrderPayResultMvpPresenter<V> {
    ...
    @Inject
    public OrderPayResultPresenter(DataManager dataManager) {
