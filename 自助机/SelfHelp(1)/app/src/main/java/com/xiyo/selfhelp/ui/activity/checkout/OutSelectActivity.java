...
import com.xiyo.selfhelp.ui.presenter.checkout.OutSelectPresenter;
...
public class OutSelectActivity extends BaseActivity implements OutSelectMvpView {

    @Inject
    OutSelectPresenter<OutSelectMvpView> mOutSelectPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOutSelectPresenter.attachView(this);
        initData();
        initView();
        addListener();
    }
...
//                startActivity(new Intent(this,SelectActivity.class));
    ...
    protected void onResume() {
        super.onResume();
        IMAudioManager.instance().playSound(RawsConstants.SELECT_CHECKOUT_ROOM, new MediaPlayer.OnCompletionListener() {
            @Override
    ...
    private void initData(){
        ...
        HashMap<String, CheckInOrder> map = (HashMap<String, CheckInOrder>)bundle.getSerializable("checkInOrderMap");
    ...
    private void initView(){
        textView.setText(getString(R.string.check_out_txt));
        ...
        adapter.setOnItemClickListener(new StaySelectAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int postion) {
                ...
                if(DoubleClickUtil.isFastClick()){
                    Intent intent = new Intent(OutSelectActivity.this, OutReservationActivity.class);
    ...
    private void login(){
        ...
        mOutSelectPresenter.login(fields);
    }
...
//        fields.put("DeviceNo", "0224e2ef-09ba-4c0d-b44e-3797b7928c26");
        ...
        mOutSelectPresenter.getRoomType(fields);
    }
}
